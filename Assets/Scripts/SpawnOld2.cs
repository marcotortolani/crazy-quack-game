...
[Serializable]
public class EnemySpawnDataOld
{
    public int amount;
    public GameObject prefab;
}

public class SpawnOld2 : MonoBehaviour
{
   
    public EnemySpawnDataOld[] enemiesToSpawn;
    ...
    private void SpawnEnemies()
    {
        ...
        foreach (EnemySpawnDataOld spawnData in enemiesToSpawn)
